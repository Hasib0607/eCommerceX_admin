...
$bkashCallBackURL = (!app()->runningInConsole() && app()->bound('request'))
    ? (request()->secure() ? 'https' : 'http') . '://' . ($_SERVER['HTTP_HOST'] ?? 'localhost') . '/affiliate/bkash/callback'
    : env('APP_URL') . '/affiliate/bkash/callback';
...
return [
    ...
    "callbackURL" => env("BKASH_CALLBACK_URL", $bkashCallBackURL),
    'timezone' => 'Asia/Dhaka',
];
